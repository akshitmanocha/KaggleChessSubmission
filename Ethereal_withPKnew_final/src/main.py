...
compressed_path = "/kaggle_simulations/agent/Ethereal.7z"
decompressed_path = "/kaggle_simulations/agent/Ethereal"

# Check if Ethereal is compressed and decompress it
